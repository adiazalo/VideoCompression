...
function [motionVect, DScomputations] = motionEstDS_SAD(imgP, imgI, mbSize, p)
...
for i = 1 : mbSize : row-mbSize+1
    for j = 1 : mbSize : col-mbSize+1
        ...
        costs(5) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
        ...
        for k = 1:9
            ...
            costs(k) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                ...
                switch point
                    case 2
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(1) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(2) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(4) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
                    ...
                    case 3
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(3) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(6) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
                    ...
                    case 7
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(7) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(9) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
                    ...
                    case 8
                        ...
                        elseif (refBlkHor < j-p || refBlkHor > j+p || refBlkVer < i-p ...
                           ...
                           costs(8) = costFuncSAD(imgP(i:i+mbSize-1,j:j+mbSize-1), ...
                                       imgI(refBlkVer:refBlkVer+mbSize-1, ...
                                          refBlkHor:refBlkHor+mbSize-1), mbSize);
                           computations = computations + 1;
                        end
